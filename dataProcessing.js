class DataSet {
    ...
    static readSum(year){
        ...
        return d3.csv("https://raw.githubusercontent.com/nordstroem92/datavisualisering/master/Data/flights_" + year + ".csv").then((data) => { //Jeg får stadig CORS errors med lokale filer :-(
            for (let i = 0; i < data.length; i++) {
